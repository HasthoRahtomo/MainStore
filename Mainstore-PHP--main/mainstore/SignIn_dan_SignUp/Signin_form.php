...
<body>
    <div class="container">
        <h2 class="txt" id="text">Sign in</h2>
        <form action="" method="post">
            <p style="color: red;"><?= $peringatan ?></p>
            ...
            <br>
            <a href="<?php echo isset($_SESSION['username']) && !empty($_SESSION['username']) ? '../index.php' : 'Signup_form.php'; ?>">
